...
const {alberca, filterItem} = usePropiedades();
...
<template>
  <main>
   ...
   <v-card flat class="p-10">
    ...
    <v-row>
      <Propiedad v-for="propiedad in filterItem" :key="propiedad.id" :propiedad="propiedad" :price="propertyPrice"/>
    </v-row>
